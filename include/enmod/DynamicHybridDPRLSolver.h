#ifndef ENMOD_DYNAMIC_HYBRID_DP_RL_SOLVER_H
#define ENMOD_DYNAMIC_HYBRID_DP_RL_SOLVER_H
...
class DynamicHybridDPRLSolver : public Solver {
public:
    DynamicHybridDPRLSolver(const Grid& grid_ref);
    void run() override;
...
#endif // ENMOD_DYNAMIC_HYBRID_DP_RL_SOLVER_H